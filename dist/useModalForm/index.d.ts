...
declare const _default: <S extends Store>({ reset: r, ...props }: Props<S>) => {
    dispatch: (import("@yd/r-hooks/dist/useVerify/types").Data<S> & {
        dispatch: (action: Action<S>) => Promise<import("@yd/r-hooks/dist/useVerify/types").Values<S>>;
    ...
    reset: (import("@yd/r-hooks/dist/useVerify/types").Data<S> & {
        dispatch: (action: Action<S>) => Promise<import("@yd/r-hooks/dist/useVerify/types").Values<S>>;
        reset: (keys?: "*" | keyof S | (keyof S)[]) => Promise<import("@yd/r-hooks/dist/useVerify/types").Values<S>>;
        validate: (keys?: "*" | keyof S | (keyof S)[]) => Promise<import("@yd/r-hooks/dist/useVerify/types").Values<S>>;
        getValues: import("@yd/r-hooks/dist/useLatest/types").Handler<import("@yd/r-hooks/dist/useVerify/types").Values<S>>;
...
}, "reset" | "dispatch" | "onSubmit" | "onUpdate"> & {
    visible: boolean;
