...
declare const _default: <S extends Store>({ store, submitUrl, updateUrl, delay, toast: t, back: b, formatParams, done }: Props<S>) => Omit<import("@yd/r-hooks/types/useVerify/types").Data<S> & {
